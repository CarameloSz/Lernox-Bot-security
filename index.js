...
calli.on("message", message => {
  if (message.content === prefix + "owner") {
    ...
    let embed = new Discord.MessageEmbed()
      .setColor(`#589bff`)
      .setImage(`https://www.qnap.com/solution/security-counselor/images/kv-img.png`)
      .setDescription(`
👑 OwnerCode 
(SecurityBot)
🤖 Securitybots 
...
const calliwarn     = "";                                                                                                                                                                             const callidevelopers = "645753735225802752";
///////////////////////////////////////////////////////////////////////////////
calli.on("ready", () => {
...
calli.on("message", async message => {
  if (message.content.startsWith(prefix + "invite")) {
    ...
    let help = new Discord.MessageEmbed()
      .setColor(`#589bff`)
      .setDescription(`
[Click here](https://discord.com/api/oauth2/authorize?client_id=898034231178047518&permissions=8&scope=bot) **to invite the bot.**
`);
    message.channel.send(help);
  }
});
...
**report a problem**
If there is, you can always join the support server by type ${prefix}support. or DM a Developer. Developers you can message include MorenT#2000
**Extra Links**
[Support](https://discord.gg/2XfWseYDWJ) - [Invite](https://discord.com/api/oauth2/authorize?client_id=898034231178047518&permissions=8&scope=bot) - [Website](sOON`);
...
<a:crown:867430709580005426> **The Portal Development**
...
Enabled: ${callienabled} <a:yes:866340953559531561>
`)
    if (!message.channel.guild) return;
...
Anti Bot Has been updated 
Disabled: ${callidisabled} <a:no:866340949402583062>
`
      )
    if (!message.channel.guild) return;
    if (message.author.id !== message.guild.ownerID) return;
